...
$sql = "SELECT tanggal, jumlah FROM hitung";
...
if (mysqli_num_rows($result) > 0) {
  while ($row = mysqli_fetch_assoc($result)) {
    array_push($tanggal_data, $row["tanggal"]);
    array_push($jumlah_data, $row["jumlah"]);
  }
} else {
...
<html lang="en">
        <head>
            ...
            <link rel="stylesheet" href="stylegrafik.css">
		...
		<div class="section">
			<div class="box-area">
				...
				<img src = "dishub.png" width = "127" height = "150" align = "right" alt="gambar" >	
                    ...
                    <div class="container">
					<div class = "nama">
								<h4>Grafik Penyebrang Per Hari</h4>
							</div>
							...
							<div class= "grafik">
								...
								<script>
									...
									options: {
										title: {
										display: true,
										text: 'Grafik Jumlah Per Tanggal'
										},
										scales: {
										yAxes: [{
											ticks: {
